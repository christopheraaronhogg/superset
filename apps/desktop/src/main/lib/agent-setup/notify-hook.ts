...
/**
 * Windows agent hooks need a native entrypoint. Prefer the packaged Electron
 * binary as Node via ELECTRON_RUN_AS_NODE so agents do not require a system
 * Node install. PowerShell is avoided so ConPTY/agent spawn paths do not need
